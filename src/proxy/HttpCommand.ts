...
class HttpCommand {
    ...
    public getGameConfig(gameId:number = 1):void
    {
        ...
        let curURL:string = `http://${GlobalData.gameDomainURL}/index.php?m=content&c=litAppBlock&a=index&mobileDomain=${GlobalData.gameDomainURL}&gameID=${GlobalData.gameId}&requstID=${HttpCommand.GameConfigID}`;
    ...
    public reportResult(userId:string,score:number,bonus:number = 0):void
    {
        ...
        let curURL:string = `http://${GlobalData.gameDomainURL}/index.php?m=content&c=acceptResult&a=add&domain=${GlobalData.gameDomainURL}&userId=${userId}&appId=${GlobalData.gameId}&score=${score}&bonus=${bonus}&requstID=${HttpCommand.reportResultID}`;
        this.postRequset(curURL);
    }
    ...
    {
        let curURL:string =
            `http://${GlobalData.gameDomainURL}/index.php?m=content&c=userRankingList&a=showList&domain=${GlobalData.gameDomainURL}&appId=${GlobalData.gameId}&sort=${sort}&requstID=${HttpCommand.rankInfoID}`;
        this.postRequset(curURL);
    }
