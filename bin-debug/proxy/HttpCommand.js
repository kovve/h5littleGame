...
var HttpCommand = (function () {
    ...
    HttpCommand.prototype.getGameConfig = function (gameId) {
        ...
        var curURL = "http://" + GlobalData.gameDomainURL + "/index.php?m=content&c=litAppBlock&a=index&mobileDomain=" + GlobalData.gameDomainURL + "&gameID=" + GlobalData.gameId + "&requstID=" + HttpCommand.GameConfigID;
    ...
    HttpCommand.prototype.reportResult = function (userId, score, bonus) {
        ...
        var curURL = "http://" + GlobalData.gameDomainURL + "/index.php?m=content&c=acceptResult&a=add&domain=" + GlobalData.gameDomainURL + "&userId=" + userId + "&appId=" + GlobalData.gameId + "&score=" + score + "&bonus=" + bonus + "&requstID=" + HttpCommand.reportResultID;
        this.postRequset(curURL);
    };
    //排序方式（1本地排行，2全国排行，3预留）
    HttpCommand.prototype.getRankList = function (sort) {
        if (sort === void 0) { sort = 0; }
        var curURL = "http://" + GlobalData.gameDomainURL + "/index.php?m=content&c=userRankingList&a=showList&domain=" + GlobalData.gameDomainURL + "&appId=" + GlobalData.gameId + "&sort=" + sort + "&requstID=" + HttpCommand.rankInfoID;
        this.postRequset(curURL);
    };
